...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://usmankhizar.com/local-seo-specialist',
    type: 'website',
  },
  twitter: {
  ...
  alternates: { canonical: 'https://usmankhizar.com/local-seo-specialist' },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Local SEO Specialist', item: 'https://usmankhizar.com/local-seo-specialist' },
  ],
}

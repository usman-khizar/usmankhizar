...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'SearchAtlas SEO Specialist | Agentic SEO Specialist | Usman Khizar',
    description: 'SearchAtlas SEO specialist and agentic SEO specialist for agencies and businesses. Expert in SearchAtlas Otto, campaign management, pixel integration, GSC, Analytics and GMB connections.',
    url: 'https://usmankhizar.com/search-atlas-seo-specialist',
    type: 'website',
  },
  twitter: {
  ...
  alternates: { canonical: 'https://usmankhizar.com/search-atlas-seo-specialist' },
}
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'SearchAtlas SEO Specialist', item: 'https://usmankhizar.com/search-atlas-seo-specialist' },
  ],
}
